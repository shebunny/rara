                    ...
                    <div id="cnttxt">
                        <div class="box-txt" style="margin-bottom: 40px;">
                            ...
                            <p style="font-size: 14px;"><span style="font-weight: 400;">
                                O peeling de diamante tambem conhecido como microdermoabrasao é um tratamento estético que faz uma esfoliacao mecanica na pele para a remoção de celulas mortas da camada mais superficial.
                                Muito utilizado para remoção de manchas mais superficiais, tratar cicatrizes de aquine, suavisar linhas de espressao, desobistruir os poros, tratar estrias e diminuir a oliosidade da pele.
